...
/* --------------------------------- End of original database --------------------------------------------------- */


/* --------------------------------- Tables added/altered for part 1 -------------------------------------------- */


ALTER TABLE applies ADD experience FLOAT;
ALTER TABLE applies ADD education FLOAT;
...
job INT(4) NOT NULL,
PRIMARY KEY (candidate_username,start_time),
CONSTRAINT INT_JOB FOREIGN KEY (job) REFERENCES applies(job_id) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT INT_CAND FOREIGN KEY (candidate_username) REFERENCES applies(cand_usrname) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;


CREATE TABLE action(
tablename VARCHAR(100) NOT NULL,
act_type ENUM('insert','delete','update'),
act_time TIMESTAMP NOT NULL,
success ENUM('successful','unsuccessful'),
act_username VARCHAR(12) NOT NULL,
PRIMARY KEY (act_time,act_username),
CONSTRAINT ACT_USR FOREIGN KEY (act_username) REFERENCES `user`(username) 
)engine=InnoDB;
...
subfield_of VARCHAR(50),
PRIMARY KEY (field_name),
CONSTRAINT SUB_FIELD FOREIGN KEY (subfield_of) REFERENCES field (field_name) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;
...
PRIMARY KEY (f_name,comp_afm),
CONSTRAINT HF_NAME FOREIGN KEY (f_name) REFERENCES field (field_name) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT HF_COMP FOREIGN KEY (comp_afm) REFERENCES etaireia (AFM) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;


ALTER TABLE job ADD applicants INT(5);


/* --------------------------------- Inserts/Updates to tables for part A --------------------------------------- */


/* additional users */
insert into `user` (username, `password`, `name`, surname, reg_date, email) values
('annam','Anna1234','Anna','Mayaki',NOW(),'annamayaki@gmail.com'),
('klelial','1234','Klelia','Lykothanasi',NOW(),'klelialykothan@gmail.com');


/* additional users -> candidates */
insert into candidate(username, bio, sistatikes, certificates) values
('annam','Anna is an undergraduate student at University of Patras at CEID. She is also a volunteer in hellenic red cross.','annam_sistatikes.pdf','annam_certificates.pdf'),
('klelial','Klelia is an undergraduate student at CEID, University of Patras. In her free time she contributes to open source projects.','klelial_sistatikes.pdf','klelial_certificates.pdf');
...
/* additional degrees */
insert into degree (titlos, idryma, bathmida) values
('Lysium certificate','Peiramatiko School of Patras University','LYKEIO');


/* additional has_degrees -> candidates */
insert into has_degree (cand_usrname, degr_title, degr_idryma, etos, grade) values
('annam','Lysium certificate','Peiramatiko School of Patras University',2016,19.3),
('klelial','Lysium certificate','Peiramatiko School of Patras University',2016,19.8);


/* additional jobs */
insert into job (start_date, salary, position, edra, recruiter, announce_date, submission_date) values
('2019-10-01',4000,'Secretary at CEID','Patra, Greece','msmith','2019-09-01','2019-09-15'),
('2019-11-06',3000,'Professor at CEID','Patra, Greece','pavkie','2019-09-15','2019-11-01');
...
update applies set experience=1,education=4 where cand_usrname='adrown' and job_id=1;
update applies set experience=0,education=2 where cand_usrname='cleogeo' and job_id=2;
update applies set experience=3,education=0 where cand_usrname='lionarF' and job_id=2;
update applies set experience=0,education=0 where cand_usrname='zazahir23' and job_id=2;
update applies set experience=3,education=4 where cand_usrname='lionarF' and job_id=3;
update applies set experience=5,education=2 where cand_usrname='zazahir23' and job_id=3;
update applies set experience=3,education=2 where cand_usrname='liagourma' and job_id=4;
update applies set experience=0,education=5 where cand_usrname='mnikol' and job_id=4;
update applies set experience=0,education=2 where cand_usrname='lionarF' and job_id=5;
update applies set experience=3,education=5 where cand_usrname='cleogeo' and job_id=7;
update applies set experience=0,education=2 where cand_usrname='lionarF' and job_id=7;
update applies set experience=1,education=4 where cand_usrname='zazahir23' and job_id=7;


insert into interview (dur,start_time,personality,candidate_username ,job) values
(0.5,'2018-12-21 10:12:13',1,'abrown',1),
(0.2,'2018-12-22 10:00:00',2,'abrown',1),
(0.4,'2019-01-12 12:12:00',4,'abrown',2),
(0.2,'2019-01-13 14:03:00',5,'abrown',2),
(0.5,'2019-01-19 12:00:00',1,'abrown',2),
(0.3,'2018-11-12 15:00:00',3,'abrown',4),
(0.2,'2019-01-20 18:10:00',5,'annam',3),
(0.4,'2019-01-22 12:19:00',4,'annam',3),
(0.3,'2019-02-15 18:10:00',2,'annam',5),
(0.4,'2019-09-20 10:15:00',5,'annam',13),
(0.2,'2019-09-25 16:15:00',5,'annam',13),
(0.5,'2018-12-28 09:00:00',0,'cleogeo',1),
(0.2,'2019-09-25 09:15:00',1,'cleogeo',2),
(0.3,'2018-11-15 10:45:00',0,'cleogeo',4),
(0.4,'2019-02-10 14:20:00',3,'cleogeo',5),
(0.1,'2019-02-12 14:20:00',2,'cleogeo',5),
(0.3,'2019-04-15 10:20:00',4,'cleogeo',7),
(0.3,'2018-12-31 12:00:00',5,'klelial',1),
(0.4,'2019-01-22 12:45:00',5,'klelial',3),
(0.2,'2019-02-25 15:00:00',4,'klelial',5),
(0.3,'2019-09-18 12:00:00',5,'klelial',13),
(0.3,'2019-09-20 12:20:00',4,'klelial',13),
(0.2,'2019-01-16 14:50:00',0,'liagourma',2),
(0.1,'2018-11-26 11:20:00',5,'liagourma',4),
(0.4,'2019-04-18 19:00:00',2,'liagourma',7),
(0.2,'2019-11-02 14:50:00',1,'liagourma',14),
(0.4,'2019-01-18 17:20:00',2,'lionarF',2),
(0.1,'2019-01-20 10:40:00',3,'lionarF',3),
(0.4,'2019-02-17 09:20:00',0,'lionarF',5),
(0.2,'2019-04-22 13:30:00',1,'lionarF',7),
(0.3,'2018-12-15 10:20:00',4,'mnikol',4),
(0.3,'2018-12-29 11:30:00',2,'zazahir23',2),
(0.2,'2019-01-10 15:40:00',0,'zazahir23',3),
(0.5,'2019-04-29 15:30:00',2,'zazahir23',7),
(0.3,'2019-11-03 11:20:00',5,'zazahir23',14);


insert into field values
('Software & Software Engineering','Root element',Null),
('Software Notation and Tools','level_1 left child ','Software & Software Engineering'),
('General Programming Languages','level_1 left child','Software Notation and Tools'),
('Software Creation & Management','level_1 right child','Software & Software Engineering'),
('Software Design', 'level_1 right cild','Software Creation & Management') ,
('Hardware','Root element',Null),
('Communication Hardware & interfaces','level_1 left child ','Hardware'),
('Signal Processing','level_1 left child ','Communication Hardware & interfaces'),
('Sensors and Actuators','level_1 right child ','Communication Hardware & interfaces');


insert into has_field values
('Software Creation & Management','023451232'),
('Software Design','023451232'),
('Software & Software Engineering','123432211'),
('Software Creation & Management','561234561');
